# -*- coding: utf-8 -*-
"""applying the test and train and oos from 2020 (Chetan's SOC).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1ZaoBW3oyIYdfexKQthziYkR_i91Q943Z
"""
...
def compare_equity(bt_dict):
    ...
    plt.axvline(pd.to_datetime(OOS_START_DATE), color='black', linestyle='--', alpha=0.5, label='OOS Split')

    plt.title(f"Strategies Equity Curves (Threshold: {POSITION_THRESHOLD*100}%)")
    plt.xlabel("Date")
